...
class DAOProveedores {
    ...
    public function InfoExcProv(){
        $query = 'SELECT pv_nit,pv_razon,pv_tel,pv_dir,pv_ciud,pv_email '
                . 'FROM proveedores ';
    ...
    public function InfoPvbusqueda(){
        $query = "SELECT * 
                    FROM proveedores
                    WHERE pv_nit LIKE '%".$this->_pv_nit."%' OR UPPER(pv_razon) LIKE '%".strtoupper($this->_pv_razon)."%'";
    ...
    public function ListarProveedoresTodos($orden = 'ASC'){
        $query = 'SELECT * '
                . 'FROM proveedores ';
    ...
    public function RegistrarProveedor(/*$valorKl*/){
        ...
        $query = 'INSERT INTO proveedores (pv_nit,pv_dv,pv_ciiu,pv_razon,pv_tel,pv_otro,
