...
class DAOClientes {
    ...
    public function InfoExcClie(){
        $query = 'SELECT cl_nit,cl_razon,cl_tel,cl_dir,cl_ciud,cl_email '
                . 'FROM clientes ';
    ...
    public function ListarClientesTodos(){
        $query = 'SELECT * '
                . 'FROM clientes ';
    ...
    public function ListarClientesNom(){
        $query = 'SELECT cl_razon '
                . 'FROM clientes ';
    ...
    public function RegistrarCliente(/*$valorKl*/){
        ...
        $query = 'INSERT INTO clientes (cl_nit,cl_dv,cl_ciiu,cl_razon,cl_tel,cl_otro,
    ...
    public function ModificarCliente(){
        ...
        $query = 'UPDATE clientes SET '.$upd.' WHERE cl_nit='.$this->_cl_nit;
        $this->_db->Query($query);
        if($this->_db->FilasAfectadas()>0){
            return true;
        }else{
    ...
    public function BorrarCliente(){
        $query = 'DELETE FROM clientes WHERE  cl_nit='.$this->_cl_nit;
        $this->_db->Query($query);
        if($this->_db->FilasAfectadas()>0){
            return true;
        }else{
