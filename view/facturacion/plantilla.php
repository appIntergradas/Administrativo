 ...
 <div class="row fila" id="tbprincipal">
  ...
  <thead>
    ...
    left:10px;">Indusesgos S.A.S<div>Oscar Correa</div><div>NIT: 900688208 </div><div>DIR: CRR 72 No. 28-13  </div></td>
            ...
            <td style= "width:10%;border-radius:0px 10px 0px 0px;border-bottom:1px solid white;border-left:1px solid white;position:relative;right:45px;">REMISION DE VENTA<div>No. <?= $fact ?> MED</div></td>
...
<tbody>
    ...
    right:10px;">F.VENCIMIENTO: <?= $fe ?><div>FORMA DE PAGO: <?= $fpago ?></div></td>
        ...
        <tr>
            ...
            <th style= "border-left:1px solid white;border-right:1px solid white;border-top:1px solid white;"></th>
        ...
        <tr>
          <td style= "border-left:1px solid white;border-right:1px solid white;border-top:1px solid white;visibility: hidden;">Esta factura se entrega a satisfacticion de quien recibe</td>
          <td style= "border:1px solid white;"></td>
