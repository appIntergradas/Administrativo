...
<tbody>
    <div > 
        <tr >
            <td style= "border-right:1px solid white;border-radius:10px 0px 0px 0px;border-bottom:1px solid white;position: relative;
    left:10px;"><div >Indusesgos S.A.S</div><div>Oscar Correa</div></td>
            ...
            <td style= "border-radius:10px 10px 0px 0px;border-bottom:1px solid white;position:relative;right:45px;">FACTURA DE VENTA</td>
        </tr>      
        <tr>
            <td style= "border-right:1px solid white;border-top:1px solid white;border-bottom:1px solid white;position: relative;
    left:10px;"><div>NIT: 900688208 </div></td>
            ...
            <td style= "border-top:1px solid white;border-bottom:1px solid white;position:relative;right:45px;"> ELECTRONICA</td>
        </tr>
        <tr>
            <td style= "border-right:1px solid white;border-top:1px solid white;border-bottom:1px solid white;position: relative;
    left:10px;"><div>DIR: CRR 72 No. 28-13  </div></td>
            ...
            <td style= "border-top:1px solid white;border-radius:0px 0px 10px 10px;position:relative;right:45px;">No. <?= $fact ?> MED</td>
        </tr>
        <tr>
            <td style= "border-right:1px solid white;border-top:1px solid white;border-radius:0px 0px 0px 10px;position: relative;
    left:10px;">Factura realizada por computador desarrollado por SO Aplicaciones Integradas NIT 1036688540-0</td>
    ...
    left:10px;">CIUDAD: <?= $ciu ?></td>
            ...
            <td style= "border-radius:0px 10px 0px 0px;border-left:1px solid white;border-bottom:1px solid white;position: relative;
    right:10px;">F.VENCIMIENTO: <?= $fe ?> </td>
           
        </tr>
        <tr>
            <td style= "border-right:1px solid white;border-bottom:1px solid white;border-top:1px solid white;position: relative;
    left:10px;">CLIENTE:: <?= $clien ?> </td>
            ...
            <td style= "border-left:1px solid white;border-bottom:1px solid white;border-top:1px solid white;position: relative;
    right:10px;">MONEDA: COP</td>
        </tr>
        <tr>
            <td style= "border-radius:0px 0px 0px 10px;border-right:1px solid white;border-top:1px solid white;position: relative;
    left:10px;">HORA EMISION:  <?= $ho ?> </td>
            ...
            <td style= "border-left:1px solid white;border-right:1px solid white;border-top:1px solid white;"></td>
            <td style= "border-radius:0px 0px 10px 0px;border-left:1px solid white;border-top:1px solid white;position: relative;
    right:10px;">FORMA DE PAGO: <?= $fpago ?></td>
        </tr>
        <tr>
            <td style= "border:1px solid white;"></td>
            <td style= "border:1px solid white;"></td>
        ...
        <tr>
          ...
          <td style= "border:1px solid white;"></td>
          <td style= "border:1px solid white;"></td>
          <td style= "border-right:1px solid white;border-radius:10px 0px 0px 0px;border-bottom:1px solid white;font-weight: 600;text-align: center;">Subtotal: </td>
    ...
    right:10px;"><?= $subtotfinal ?></td>
        ...
        <tr>
          ...
          <td style= "border:1px solid white;"></td>
          <td style= "border:1px solid white;"></td>
          <td style= "border-top:1px solid white;border-right:1px solid white;border-bottom:1px solid white;text-align: center;">Iva 19:</td>
          <td style= "border-left:1px solid white;border-top:1px solid white;border-bottom:1px solid white;text-align: center;position: relative;
    right:10px;"></td>
        </tr>
        <tr>
          ...
          <td style= "border-top:1px solid white;border-right:1px solid white;border-bottom:1px solid white;text-align: center;">Iva 5:</td>
          <td style= "border-left:1px solid white;border-top:1px solid white;border-bottom:1px solid white;text-align: center;position: relative;
    right:10px;"></td>
        </tr>
        <tr>
          ...
          <td style= "border:1px solid white;"></td>
          <td style= "border:1px solid white;"></td>
          <td style= "border-top:1px solid white;border-right:1px solid white;border-bottom:1px solid white;text-align: center;">Iva EX:</td>
          <td style= "border-left:1px solid white;border-top:1px solid white;border-bottom:1px solid white;text-align: center;position: relative;
    right:10px;"></td>
        </tr>
        <tr>
          <td style= "border-left:1px solid white;border-right:1px solid white;border-top:1px solid white;position:relative;left:25px;"></td>
          <td style= "border:1px solid white;"></td>
          <td style= "border:1px solid white;"></td>
          <td style= "border-top:1px solid white;border-right:1px solid white;border-bottom:1px solid white;text-align: center;">RteFte: </td>
          <td style= "border-left:1px solid white;border-top:1px solid white;border-bottom:1px solid white;text-align: center;position: relative;
    right:10px;"></td>
        </tr>
        <tr>
          <td style= "border:1px solid white;position:relative;left:225px;">Recibido por</td>
          <td style= "border:1px solid white;"></td>
          <td style= "border:1px solid white;"></td>
          <td style= "border-right:1px solid white;border-top:1px solid white;border-radius:0px 0px 0px 10px;font-weight: 600;text-align: center;">TOTAL: </td>
