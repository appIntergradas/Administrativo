...
<div class="row">
      ...
      <div class="btncerrarf">
          <input type="button" class="btn btn-outline-danger btncf" id="btn-cerrar" name="btn-cerrar" value="X" onclick="javascript:Cerrarvistacmanul();">
      </div>
    </div>
...
<div class="row">
  <div class="alert alert-dark row fila col-xl-12"> 
    <span id="respuestanulco"></span> 
  </div>  
 </div>
</div><!--cierro container-->

<!-- Modal confirmacion anulacion compra -->
<div class="modal fade" id="Modalcompanul" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title title-modal" id="exampleModalCenterTitle">¿Esta seguro de anular la compra?</h5>
      ...
      <div class="modal-body">
            <div class="input-conf-anul-comp col-xl-12">
              <div class="form-group ">
                <input type="text" class="form-control inp-conf-anul-comp" id="conf-anul-comp" name="conf-anul-comp" readonly>
              </div>
            </div>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal" onclick="javascript:OcultarBusqueda();">Cancelar</button>
        <button type="button" class="btn btn-primary"  data-dismiss="modal" onclick="javascript:DelCompanul();" >Aceptar</button>
      </div>
      </form>
    </div>
  </div>
</div>
<!-- fin Modal confirmacion anulacion compra -->
