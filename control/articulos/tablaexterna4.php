...
if($per->Autorizar($_SESSION['usuario']->get_permisos(),1)!= false){
    ...
    <html>
       ...
       <body>
    <table id="articulos9" class="display" style="width:1140px; color:#000138;">
    <thead>
        <tr>
    ...
    foreach ($arti as $key => $value) {
        ...
        $bitArtTabla.='<tr>
                        ...
                        <td style="text-align: center;"><button onClick="javascript:DelArt('.$value['art_id'].');" class="btn btn-danger"><i class="fas fa-trash" aria-hidden="true"></i></button></td>
                    </tr>';
    }
    $bitArtTabla.='</tbody>
    <tfoot>
