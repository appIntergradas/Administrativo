...
if($per->Autorizar($_SESSION['usuario']->get_permisos(),1)!= false){
    ...
    foreach ($articulostm as $key => $value) {
        ...
        $bitArticulosTabla.='<tr>
                        ...
                        <td style="text-align: left;"><input type="text" class="inpartcant" name="artcant" id="artcant'.$value['art_id'].'" value="'.$value['art_cantidad'].'" onkeyup="javascript: updatevalco('.$value['art_id'].');"></td>
                        <td style="text-align: left;"><input type="text" class="inpartpventa" name="artpventa" id="artpventa'.$value['art_id'].'" value="'.$value['art_pventa'].'" onkeyup="javascript: updatevalco('.$value['art_id'].');"></td>
