...
if($per->Autorizar($_SESSION['usuario']->get_permisos(),1)!= false){
    ...
    $artemp3->set_identificacion_usu($ident);
    $articulostm=$artemp3->ListarArticulosTodostemp();
    ...
    <div class="form-group ">
      <input type="text" class="form-control inp-total-fact" id="total-comp" placeholder="0.00" value="'.$totalfinal.'">
    </div>
    </body>
  </html>';
  echo $totalfact;
