...
if($per->Autorizar($_SESSION['usuario']->get_permisos(),1)!= false){
    ...
    <html>
       ...
       <body>
    <table id="factapagarb3" class="display" style="width:100%">
    <thead>
        <tr>
            <th>NUMERO</th>
            <th>CONCEPTO</th>
    ...
    foreach ($reci as $key => $value8) {
      ...
      $bitTablapagarb.='<tr>
                            ...
                            <td style="text-align: center;"><button onClick="javascript: Delfacrb('.$value8['num_factrb'].');" class="btn btn-danger"><i class="fas fa-trash" aria-hidden="true"></i></button></td>
                       </tr>';
    }
  ...
  <script>
  var table=$("#factapagarb3").DataTable( {
                  responsive: true,
                  "scrollY":        "1500px",
                  "autoWidth": true,
                  "scrollCollapse": true,
